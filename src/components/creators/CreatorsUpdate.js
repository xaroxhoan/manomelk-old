...
const CreatorsUpdate = ({ defaultInfo, onUpdated, onCancel }) => {
  ...
  const onUpdate = async () => {
    ...
    try {
      const response = await creators.update(defaultInfo._id, {
        name: state.name,
        family: state.family,
        mobile: state.mobile,
