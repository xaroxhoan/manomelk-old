...
const MenusCreate = () => {
  ...
  const onSave = async () => {
    try {
      const response = await menus.store({
        title: state.title,
        slug: state.slug,
        ...
        <CardBody>
          ...
          <Row>
            <Col lg='6' md='12'>
              <div className='mb-2'>
                <Label>Title</Label>
                <Input placeholder='Title...' onChange={ e => setState({ ...state, title: e.target.value }) } invalid={ state.errors.title !== undefined } />
            ...
            <Col lg='6' md='12'>
              <div className='mb-2'>
                <Label>Slug</Label>
                <Input placeholder='Slug...' onChange={ e => setState({ ...state, slug: e.target.value }) } invalid={ state.errors.slug !== undefined } />
