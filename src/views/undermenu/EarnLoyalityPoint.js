...
const EarnLoyalityPoint = () => {
  ...
  useEffect(async () => {
    try {
      const response = await setting.getByGroupAndKey('undermenu', 'earnLoyalityPoints')
  ...
  const onSave = async () => {
    try {
      ...
      const response = await setting.store('undermenu', 'earnLoyalityPoints', state.description)
      ...
      <Card>
        <CardHeader>
          <CardTitle className='has-action'>
            <span>Earn Loyality Points</span>
